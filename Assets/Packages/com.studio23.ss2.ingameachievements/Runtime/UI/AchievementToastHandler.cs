        ...
        AchievementIcon.DOFade(0.8f, 1f)
            .OnComplete((() =>
            {
                RadialIcon.transform.DOScale(RadialIcon.transform.localScale * 120f, 0.5f)
                    .OnComplete((() =>
                    {
                        AchievementIcon.rectTransform.DOMove(AchievementIcon.rectTransform.position - new Vector3(100,0,0), 0.5f);
                        RadialIcon.rectTransform.DOMove(RadialIcon.rectTransform.position - new Vector3(100,0,0), 0.5f);
                        DescriptionPanel.rectTransform.DOMove(RadialIcon.rectTransform.position - new Vector3(100,0,0), 0.5f)
                            .OnComplete((() =>
                            {
                                ...
                                DescriptionPanel.rectTransform.DOScale(new Vector3(5,1,1),1f)
                                    .OnComplete((() =>
                                    {
                                        ...
                                        DescriptionPanel.rectTransform.DOScale(new Vector3(0, 1, 1), 1f).SetDelay(3f)
                                            .OnComplete((() =>
                                            {
