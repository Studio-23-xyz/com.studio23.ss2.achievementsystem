...
public class AchievementPopupAnimation : MonoBehaviour
{
    ...
    {
        AchievementIcon.sprite = Sprite.Create(achievementIcon, new Rect(0, 0, achievementIcon.width, achievementIcon.height), new Vector2(0.5f, 0.5f)); ;
